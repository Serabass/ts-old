...
Язык прекрасно поддерживается всеми современными IDE, в числе которых `JetBrains WebStorm` и Майкрософтовский `VSCode`. Недавно слушал [подкаст](https://medium.com/devschacht/devschacht-61-75ac8fd58960) от разработчика плагина TypeScript для JetBrains, но вам я его не покажу.
