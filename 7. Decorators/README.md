...
Декораторы используются только в связке с классами, их свойствами и методами. Это значит, что к свободно объявленной функции/переменной/константе декоратор применить нельзя.
